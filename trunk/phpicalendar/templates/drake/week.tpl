							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="G10B">
								<tr>
									<td align="center" valign="top">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="left" valign="top" class="rowOff2" onmouseover="this.className='rowOn2'" onmouseout="this.className='rowOff2'" onclick="window.location.href='?cal={CAL}&amp;getdate={PREV_WEEK}'">
													<div class="V12">&nbsp;<a class="psf" href="?cal={CAL}&amp;getdate={PREV_WEEK}">&lsaquo;&nbsp;</a></div>
												</td>
												<!-->
												...
												<-->
												<td alight="right" valign="top" class="rowOff" onmouseover="this.className='rowOn'" onmouseout="this.className='rowOff'" onclick="window.location.href='?cal={CAL}&amp;getdate={NEXT_WEEK}'" colspan="3">
													<div class="V12"><a style="font-size:10px;" class="psf" href="?cal={CAL}&amp;getdate={NEXT_WEEK}">next week &rsaquo;</a>&nbsp;</div>
												</td>
												<td width="1"></td>
												<!-- loop daysofweek on -->
